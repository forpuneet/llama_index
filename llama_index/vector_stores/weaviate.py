...
def _transform_weaviate_filter_operator(operator: str) -> str:
    ...
    elif operator == "ContainsAny":  # Update By Chitransh
        return "ContainsAny"         # Update By Chitransh
    elif operator == "ContainsAll":  # Update By Chitransh
        return "ContainsAll"         # Update By Chitransh
    else:
    ...
    if standard_filters.filters:
        for filter in standard_filters.filters:
            ...
            if isinstance(filter.value, float):
                ...
                value_type = "valueNumber"
            elif isinstance(filter.value, list) and (isinstance(filter.value[0], int) or isinstance(filter.value[0], float)): # Update By Chitransh
                value_type = "valueNumber"                                                                                    # Update By Chitransh
        ...
        return {}
    logger.debug(f"weaviate_filter: \n\n{filters_list}\n\n")       # Update By Chitransh
    print(f"weaviate_filter: \n\n{filters_list}\n\n")              # Update By Chitransh
