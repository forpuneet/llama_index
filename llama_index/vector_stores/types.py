...
class FilterOperator(str, Enum):
    ...
    CONTAINS_ANY = "ContainsAny"  # In array (string or array)         # Update By Chitransh
    CONTAINS_ALL = "ContainsAll"  # I n array (string or array)        # Update By Chitransh
...
class MetadataFilter(BaseModel):
    ...
    key: str
    value: Union[StrictInt, StrictFloat, StrictStr, List[Union[StrictInt, StrictFloat, StrictStr]]] # Update By Chitransh
